...
type Cle =
  ...
  | "notifs_statut_on"
  | "notifs_statut_off"
  | "err_commerce_introuvable"
  | "err_tel_invalide"
  | "err_nom_requis"
  | "err_creation_carte"
  | "err_carte_introuvable_tel"
  | "err_carte_nexiste_plus"
  | "err_carte_expiree"
  | "err_demander_commercant"
  | "err_scannez_qr_caisse"
  | "err_deja_tampon_jour"
  | "err_deja_tampon_carte"
  | "err_carte_pleine"
  | "err_ajout_impossible"
  | "err_carte_pas_pleine"
  | "err_recompense_introuvable"
...
const FR: Traductions = {
  ...
  err_commerce_introuvable: "Commerce introuvable.",
  err_tel_invalide: "Numéro de téléphone invalide (format attendu : 06 12 34 56 78).",
  err_nom_requis: "Entrez au moins un nom ou un prénom.",
  err_creation_carte: "Impossible de créer votre carte. Réessayez.",
  err_carte_introuvable_tel: "Carte introuvable. Entrez votre numéro de téléphone.",
  err_carte_nexiste_plus: "Cette carte n'existe plus.",
  err_carte_expiree: "Cette carte a expiré.",
  err_demander_commercant: "Demandez au commerçant de scanner votre QR code personnel pour recevoir votre tampon.",
  err_scannez_qr_caisse: "Scannez le QR code affiché en caisse pour prendre votre tampon 📷",
  err_deja_tampon_jour: "Vous avez déjà pris votre tampon du jour. À bientôt !",
  err_deja_tampon_carte: "Vous avez déjà pris votre tampon aujourd'hui sur cette carte.",
  err_carte_pleine: "Carte pleine : choisissez d'abord votre récompense !",
  err_ajout_impossible: "Impossible d'ajouter le tampon.",
  err_carte_pas_pleine: "Cette carte n'est pas encore pleine.",
  err_recompense_introuvable: "Récompense introuvable.",
...
const EN: Traductions = {
  ...
  err_commerce_introuvable: "Business not found.",
  err_tel_invalide: "Invalid phone number (expected format: 06 12 34 56 78).",
  err_nom_requis: "Enter at least a first or last name.",
  err_creation_carte: "Could not create your card. Please try again.",
  err_carte_introuvable_tel: "Card not found. Enter your phone number.",
  err_carte_nexiste_plus: "This card no longer exists.",
  err_carte_expiree: "This card has expired.",
  err_demander_commercant: "Ask the merchant to scan your personal QR code to receive your stamp.",
  err_scannez_qr_caisse: "Scan the QR code at the counter to get your stamp 📷",
  err_deja_tampon_jour: "You've already got your stamp for today. See you soon!",
  err_deja_tampon_carte: "You've already got your stamp today on this card.",
  err_carte_pleine: "Card full: choose your reward first!",
  err_ajout_impossible: "Could not add the stamp.",
  err_carte_pas_pleine: "This card isn't full yet.",
  err_recompense_introuvable: "Reward not found.",
...
const ES: Traductions = {
  ...
  err_commerce_introuvable: "Comercio no encontrado.",
  err_tel_invalide: "Número de teléfono no válido (formato esperado: 06 12 34 56 78).",
  err_nom_requis: "Introduce al menos un nombre o apellido.",
  err_creation_carte: "No se pudo crear tu tarjeta. Inténtalo de nuevo.",
  err_carte_introuvable_tel: "Tarjeta no encontrada. Introduce tu número de teléfono.",
  err_carte_nexiste_plus: "Esta tarjeta ya no existe.",
  err_carte_expiree: "Esta tarjeta ha caducado.",
  err_demander_commercant: "Pide al comerciante que escanee tu código QR personal para recibir tu sello.",
  err_scannez_qr_caisse: "Escanea el código QR en la caja para obtener tu sello 📷",
  err_deja_tampon_jour: "Ya has recibido tu sello de hoy. ¡Hasta pronto!",
  err_deja_tampon_carte: "Ya has recibido tu sello hoy en esta tarjeta.",
  err_carte_pleine: "Tarjeta llena: ¡elige primero tu recompensa!",
  err_ajout_impossible: "No se pudo añadir el sello.",
  err_carte_pas_pleine: "Esta tarjeta aún no está llena.",
  err_recompense_introuvable: "Recompensa no encontrada.",
...
const DE: Traductions = {
  ...
  err_commerce_introuvable: "Geschäft nicht gefunden.",
  err_tel_invalide: "Ungültige Telefonnummer (erwartetes Format: 06 12 34 56 78).",
  err_nom_requis: "Geben Sie mindestens einen Vor- oder Nachnamen ein.",
  err_creation_carte: "Ihre Karte konnte nicht erstellt werden. Bitte erneut versuchen.",
  err_carte_introuvable_tel: "Karte nicht gefunden. Geben Sie Ihre Telefonnummer ein.",
  err_carte_nexiste_plus: "Diese Karte existiert nicht mehr.",
  err_carte_expiree: "Diese Karte ist abgelaufen.",
  err_demander_commercant: "Bitten Sie den Händler, Ihren persönlichen QR-Code zu scannen, um Ihren Stempel zu erhalten.",
  err_scannez_qr_caisse: "Scannen Sie den QR-Code an der Kasse, um Ihren Stempel zu erhalten 📷",
  err_deja_tampon_jour: "Sie haben Ihren heutigen Stempel bereits erhalten. Bis bald!",
  err_deja_tampon_carte: "Sie haben heute bereits Ihren Stempel auf dieser Karte erhalten.",
  err_carte_pleine: "Karte voll: Wählen Sie zuerst Ihre Belohnung!",
  err_ajout_impossible: "Der Stempel konnte nicht hinzugefügt werden.",
  err_carte_pas_pleine: "Diese Karte ist noch nicht voll.",
  err_recompense_introuvable: "Belohnung nicht gefunden.",
...
const ZH: Traductions = {
  ...
  err_commerce_introuvable: "未找到商家。",
  err_tel_invalide: "电话号码无效（格式示例：06 12 34 56 78）。",
  err_nom_requis: "请至少输入姓或名。",
  err_creation_carte: "无法创建您的卡片，请重试。",
  err_carte_introuvable_tel: "未找到卡片。请输入您的电话号码。",
  err_carte_nexiste_plus: "此卡片已不存在。",
  err_carte_expiree: "此卡片已过期。",
  err_demander_commercant: "请让商家扫描您的个人二维码以获得印章。",
  err_scannez_qr_caisse: "扫描收银台的二维码以获得印章 📷",
  err_deja_tampon_jour: "您今天已经领取了印章。回头见！",
  err_deja_tampon_carte: "您今天已在此卡片上领取了印章。",
  err_carte_pleine: "卡片已满：请先选择您的奖励！",
  err_ajout_impossible: "无法添加印章。",
  err_carte_pas_pleine: "此卡片尚未集满。",
  err_recompense_introuvable: "未找到奖励。",
...
const AR: Traductions = {
  ...
  err_commerce_introuvable: "المتجر غير موجود.",
  err_tel_invalide: "رقم هاتف غير صالح (الصيغة المتوقعة: 06 12 34 56 78).",
  err_nom_requis: "أدخل الاسم الأول أو اسم العائلة على الأقل.",
  err_creation_carte: "تعذّر إنشاء بطاقتك. حاول مرة أخرى.",
  err_carte_introuvable_tel: "البطاقة غير موجودة. أدخل رقم هاتفك.",
  err_carte_nexiste_plus: "لم تعد هذه البطاقة موجودة.",
  err_carte_expiree: "انتهت صلاحية هذه البطاقة.",
  err_demander_commercant: "اطلب من التاجر مسح رمز QR الشخصي الخاص بك للحصول على ختمك.",
  err_scannez_qr_caisse: "امسح رمز QR عند الصندوق للحصول على ختمك 📷",
  err_deja_tampon_jour: "لقد حصلت على ختم اليوم بالفعل. إلى اللقاء!",
  err_deja_tampon_carte: "لقد حصلت اليوم على ختم على هذه البطاقة بالفعل.",
  err_carte_pleine: "البطاقة ممتلئة: اختر مكافأتك أولاً!",
  err_ajout_impossible: "تعذّر إضافة الختم.",
  err_carte_pas_pleine: "هذه البطاقة ليست ممتلئة بعد.",
  err_recompense_introuvable: "المكافأة غير موجودة.",
...
const RU: Traductions = {
  ...
  err_commerce_introuvable: "Заведение не найдено.",
  err_tel_invalide: "Неверный номер телефона (формат: 06 12 34 56 78).",
  err_nom_requis: "Введите хотя бы имя или фамилию.",
  err_creation_carte: "Не удалось создать карту. Попробуйте ещё раз.",
  err_carte_introuvable_tel: "Карта не найдена. Введите номер телефона.",
  err_carte_nexiste_plus: "Эта карта больше не существует.",
  err_carte_expiree: "Срок действия этой карты истёк.",
  err_demander_commercant: "Попросите продавца отсканировать ваш личный QR-код, чтобы получить штамп.",
  err_scannez_qr_caisse: "Отсканируйте QR-код на кассе, чтобы получить штамп 📷",
  err_deja_tampon_jour: "Вы уже получили штамп на сегодня. До скорого!",
  err_deja_tampon_carte: "Вы уже получили сегодня штамп на этой карте.",
  err_carte_pleine: "Карта заполнена: сначала выберите награду!",
  err_ajout_impossible: "Не удалось добавить штамп.",
  err_carte_pas_pleine: "Эта карта ещё не заполнена.",
  err_recompense_introuvable: "Награда не найдена.",
