...
type CleDash =
  ...
  | "camera_acces_impossible"
  | "pointez_camera_client"
  | "fermer"
  | "nouveau_scan"
  | "derniers_tampons"
  | "reduire_liste"
...
const FR: Traductions = {
  ...
  camera_acces_impossible: "Impossible d'accéder à la caméra. Autorisez l'accès dans les réglages du navigateur.",
  pointez_camera_client: "Pointez la caméra vers le QR code du client",
  fermer: "✕ Fermer",
  nouveau_scan: "Nouveau scan",
  derniers_tampons: "Derniers tampons donnés",
  reduire_liste: "Réduire",
  afficher_liste: "Afficher",
  aucun_tampon_recent: "Aucun tampon donné récemment.",
...
const EN: Traductions = {
  ...
  camera_acces_impossible: "Cannot access the camera. Allow access in your browser settings.",
  pointez_camera_client: "Point the camera at the customer's QR code",
  fermer: "✕ Close",
  nouveau_scan: "New scan",
  derniers_tampons: "Recently given stamps",
  reduire_liste: "Collapse",
  afficher_liste: "Show",
  aucun_tampon_recent: "No stamps given recently.",
...
const ES: Traductions = {
  ...
  camera_acces_impossible: "No se puede acceder a la cámara. Permite el acceso en los ajustes del navegador.",
  pointez_camera_client: "Apunta la cámara al código QR del cliente",
  fermer: "✕ Cerrar",
  nouveau_scan: "Nuevo escaneo",
  derniers_tampons: "Últimos sellos dados",
  reduire_liste: "Reducir",
  afficher_liste: "Mostrar",
  aucun_tampon_recent: "No se han dado sellos recientemente.",
  ...
  retirer_image: "Quitar la imagen",
...
const DE: Traductions = {
  ...
  camera_acces_impossible: "Kamerazugriff nicht möglich. Erlauben Sie den Zugriff in den Browsereinstellungen.",
  pointez_camera_client: "Richten Sie die Kamera auf den QR-Code des Kunden",
  fermer: "✕ Schließen",
  nouveau_scan: "Neuer Scan",
  derniers_tampons: "Zuletzt vergebene Stempel",
  reduire_liste: "Einklappen",
  afficher_liste: "Anzeigen",
  aucun_tampon_recent: "Kürzlich keine Stempel vergeben.",
...
const ZH: Traductions = {
  ...
  camera_acces_impossible: "无法访问相机。请在浏览器设置中允许访问。",
  pointez_camera_client: "将相机对准客户的二维码",
  fermer: "✕ 关闭",
  nouveau_scan: "新扫描",
  derniers_tampons: "最近发放的印章",
  reduire_liste: "收起",
  afficher_liste: "显示",
  aucun_tampon_recent: "最近未发放印章。",
...
const AR: Traductions = {
  ...
  camera_acces_impossible: "تعذر الوصول إلى الكاميرا. اسمح بالوصول في إعدادات المتصفح.",
  pointez_camera_client: "وجّه الكاميرا نحو رمز QR الخاص بالعميل",
  fermer: "✕ إغلاق",
  nouveau_scan: "مسح جديد",
  derniers_tampons: "آخر الأختام الممنوحة",
  reduire_liste: "طيّ",
  afficher_liste: "عرض",
  aucun_tampon_recent: "لم تُمنح أختام مؤخراً.",
...
const RU: Traductions = {
  ...
  camera_acces_impossible: "Нет доступа к камере. Разрешите доступ в настройках браузера.",
  pointez_camera_client: "Наведите камеру на QR-код клиента",
  fermer: "✕ Закрыть",
  nouveau_scan: "Новое сканирование",
  derniers_tampons: "Недавно выданные печати",
  reduire_liste: "Свернуть",
  afficher_liste: "Показать",
  aucun_tampon_recent: "Печати недавно не выдавались.",
  ...
  retirer_image: "Убрать изображение",
