...
export default function Confidentialite() {
  return (
    <LegalLayout titre="Politique de confidentialité" maj="août 2026">
      ...
      <p>
        Le responsable du traitement est <AComplter>[à compléter — nom / raison sociale]</AComplter>,
        joignable à <a href="mailto:walletiz.fr@gmail.com">walletiz.fr@gmail.com</a>.
      </p>
